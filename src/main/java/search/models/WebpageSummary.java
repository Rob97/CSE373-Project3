 ...
 *
 * The code we've given you is structured so we have access to those two pieces
 * of information for as little time as possible so we can garbage-collect them
